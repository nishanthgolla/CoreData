...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    CoursesTableViewTableViewController *cvtc = (CoursesTableViewTableViewController *)[[navigation viewControllers]objectAtIndex:0];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "NishanthGolla.CoreDataApp" in the application's documents directory.
